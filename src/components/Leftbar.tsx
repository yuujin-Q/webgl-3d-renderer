...
const Leftbar = () => {
    ...
    return <div className="border-r border-gray-600 bg-gray-700 w-3/12 overflow-auto">
        <div
            className="flex flex-col pl-4 pr-6 py-4 border-b border-gray-500 text-white w-full"
        >
        ...
        <div
            className="flex flex-col pl-4 pr-6 py-2 gap-1 border-b border-gray-500 text-white w-full"
        >
        ...
        <div
            className="flex flex-row pl-4 pr-6 py-2 gap-1 border-b border-gray-500 text-white w-full"
        >
        ...
        >
            <div className="flex">
                ...
                >
                    ...
                    />
                    <div
                        className="w-11 h-6 bg-red-200 rounded-full peer peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"
                    ></div>
                </label>
                <span
                    className="ml-3 text-sm font-medium text-gray-900 dark:text-gray-300"
